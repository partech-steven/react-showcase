...
export class Task extends Component {
    render() {
        ...
        return (
            <div className="task col-sm-12 col-md-4">
                    ...
                    <div className="task__header">
                        <div className={"task__user task__user--" + assignee.status}>
                            <div className="task__user-img">
                                ...
                                <div className={"task__user-status task__user-status--" + assignee.status}></div>
                            </div>
                        ...
                        <div className="task__details">
                            ...
                            <div className="task__project-name"><em>{task.project.name}</em></div>
                        </div>
